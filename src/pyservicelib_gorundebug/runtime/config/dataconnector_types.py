...
from ...api.models.kafka_security_protocol import KafkaSecurityProtocol
...
class KafkaDataConnectorConfig(DataConnectorConfig):
    ...
    def __init__(self, id: int, name: str, implementation: DataConnectorImplementation,
                 ...
                 sasl_mechanism: KafkaSaslMechanism = KafkaSaslMechanism.PLAIN,
    ...
    @property
    def security_protocol(self) -> KafkaSecurityProtocol:
        return self._security_protocol

    @property
    def sasl_mechanism(self) -> KafkaSaslMechanism:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        result["securityProtocol"] = self._security_protocol.value
        result["saslMechanism"] = self._sasl_mechanism.value
